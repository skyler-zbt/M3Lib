...
- 核心 GLSL 数学函数（normalize、dot、cross、length、distance、abs、sign、floor、ceil、fract、mod、clamp、mix、step、smoothstep、min、max、sin、cos、tan、asin、acos、atan、atan2、radians、degrees、pow、exp、log、exp2、log2、sqrt、inversesqrt、reflect、refract）
...
> **注意：** 其他平台（Windows、macOS）和编译器（Clang、MSVC）尚未支持。
> 跨平台 CI 计划在 v0.5.0 实现。
